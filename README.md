...
[从控制台读取一个字符](https://github.com/yaoningvital/BackEndBlog/issues/45) | `nextLine()` `charAt(index)` | [比较字符串的方法](https://github.com/yaoningvital/BackEndBlog/issues/46) | `comparing strings`
[从字符串中截取子字符串](https://github.com/yaoningvital/BackEndBlog/issues/47) | `substring()` | []() | 
